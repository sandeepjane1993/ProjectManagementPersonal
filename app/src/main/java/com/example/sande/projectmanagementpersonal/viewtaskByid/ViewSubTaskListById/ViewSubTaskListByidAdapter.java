...
public class ViewSubTaskListByidAdapter extends RecyclerView.Adapter<ViewSubTaskListByidAdapter.ProductListViewHolder> implements View.OnClickListener{
    private Context context;
    private List<ViewSubTaskListByIdPojo> List;
    private OnItemClickListener onItemClickListener;

    public ViewSubTaskListByidAdapter(Context context, List<ViewSubTaskListByIdPojo> List) {
