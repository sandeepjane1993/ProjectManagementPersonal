...
public class ViewTeamMenberByTask extends Fragment implements TeamMenberListByTaskInterface.FragmentView {
    ...
    public void retrofit() {
        ...
        apiService.getTeamListByTask(sharedPreferences.getString("taskId", null), sharedPreferences.getString("projectId", null))
                ...
                public void onItemClick(View v, int position) {
                    ...
                    editor.commit();
                        getActivity().getSupportFragmentManager()
                                    .beginTransaction()
                                    .replace(R.id.container, new EmployeeDetailFragment()).
                                    addToBackStack(null)
                                    .commit();
                }
            });
