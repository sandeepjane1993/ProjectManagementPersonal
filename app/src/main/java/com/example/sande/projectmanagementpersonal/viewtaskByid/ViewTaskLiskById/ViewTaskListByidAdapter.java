...
public class ViewTaskListByidAdapter extends RecyclerView.Adapter<ViewTaskListByidAdapter.ProductListViewHolder> implements View.OnClickListener{
    private Context context;
    private List<ViewTaskListByIdPojo> List;
    private OnItemClickListener onItemClickListener;

    public ViewTaskListByidAdapter(Context context, List<ViewTaskListByIdPojo> List) {
    ...
    public ProductListViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int position) {
        ...
        if(List.size()<=0){
            ...
            View view = LayoutInflater.from(context).inflate(R.layout.item_view_task_list_by_id, parent, false);
    ...
    public void onBindViewHolder(@NonNull ProductListViewHolder holder, int position) {
        if(List.size()>0){
        holder.tv.setText("Projectid: " + List.get(position).getProjectid()+ "\n"+
                "Taskid: " + List.get(position).getTaskid()+ "\n"+
                "Subtaskid: " + List.get(position).getSubtaskid()+ "\n"
    ...
    public class ProductListViewHolder extends RecyclerView.ViewHolder {
        ...
        public ProductListViewHolder(@NonNull View view) {
            super(view);
            tv = view.findViewById(R.id.tv_viewtaskbyid_listitem);
