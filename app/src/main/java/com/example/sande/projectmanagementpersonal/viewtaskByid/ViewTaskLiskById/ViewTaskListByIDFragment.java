...
public class ViewTaskListByIDFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        //TODO String id = mySharedPrefences.getSharePreference(this).getString("id", null);

        Log.i(TAG, "onCreateView: "+sharedPreferences.getString("userId",null));
        Call<ViewTaskListByIdResponce> call = apiService.get_View_task_list_by_id_response(sharedPreferences.getString("userId",null));
